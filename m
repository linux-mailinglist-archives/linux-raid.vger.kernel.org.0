Return-Path: <linux-raid+bounces-2324-lists+linux-raid=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-raid@lfdr.de
Delivered-To: lists+linux-raid@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 230B694B1D9
	for <lists+linux-raid@lfdr.de>; Wed,  7 Aug 2024 23:15:00 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D9C2F283BF5
	for <lists+linux-raid@lfdr.de>; Wed,  7 Aug 2024 21:14:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 288C314F108;
	Wed,  7 Aug 2024 21:14:13 +0000 (UTC)
X-Original-To: linux-raid@vger.kernel.org
Received: from mail.stoffel.org (mail.stoffel.org [172.104.24.175])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7501914D29C
	for <linux-raid@vger.kernel.org>; Wed,  7 Aug 2024 21:14:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=172.104.24.175
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723065252; cv=none; b=p4hS3o4IobxsmDJK2VDq7c4HbbWMciXQAF9QPsTPuk2ePVxF6Amh9slI4o7wTDf2eXpNTbXELjVGdIHGhU+TD5UmpVdAbVNEactYBLZtV/rjIfBWwqXlOfk0V+XRbtlqrH+CNEuxyU0ti0x2WU1ygWwkema/t1O0CXuRaZGPBR4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723065252; c=relaxed/simple;
	bh=eMxQbZxnq3/PrR3gC3FLUSMx4accrdGLxhbjKR5kuso=;
	h=MIME-Version:Content-Type:Message-ID:Date:From:To:Cc:Subject:
	 In-Reply-To:References; b=Eltm3XpjVoPq8ybqC+c+A18e8yce5YcMgUGoF2cmqGXwy0xUBtNJHxL3Gw+Ufr90Q4Fje4q0zkgiU5maqKwXK3ZH+XwPosIUSHW6yT1GL2XRXI1ypFaEPFv5roIyUeucNMSIeuVuupUZ2jwua2Hc8ThrpyXCrI+J74Cnr4Ixp3U=
...
Received: from quad.stoffel.org (syn-097-095-183-072.res.spectrum.com [97.95.183.72])
	...
	(No client certificate requested)
	by mail.stoffel.org (Postfix) with ESMTPSA id AD2641E039;
	Wed,  7 Aug 2024 17:05:03 -0400 (EDT)
Received: by quad.stoffel.org (Postfix, from userid 1000)
	id 6E830A08BC; Wed,  7 Aug 2024 17:05:03 -0400 (EDT)
Precedence: bulk
...
Message-ID: <26291.57727.410499.243125@quad.stoffel.home>
Date: Wed, 7 Aug 2024 17:05:03 -0400
...
In-Reply-To: <22C5E55F-9C50-4DB7-B656-08BEC238C8A7@flyingcircus.io>
...
> The config is unchanged except from the deprecated NFSD_V2_ACL and NF=
SD_V3 options which I had to remove. NFS is not in use on this server, =
though.
...
> [ 4549.851616] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4549.860421] task:kworker/u64:7   state:D stack:    0 pid:  432 ppi=
...
> [ 4549.860535]  </TASK>
> [ 4549.860536] INFO: task kworker/u64:23:448 blocked for more than 12=
2 seconds.
> [ 4549.868461]       Not tainted 5.15.164 #1-NixOS
> [ 4549.873555] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4549.882358] task:kworker/u64:23  state:D stack:    0 pid:  448 ppi=
d:     2 flags:0x00004000
...
> [ 4549.882442]  </TASK>
> [ 4549.882497] INFO: task .backy-wrapped:2578 blocked for more than 1=
22 seconds.
> [ 4549.890517]       Not tainted 5.15.164 #1-NixOS
> [ 4549.895611] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4549.904406] task:.backy-wrapped  state:D stack:    0 pid: 2578 ppi=
...
0000000000000052
> [ 4549.904548] RAX: ffffffffffffffda RBX: 00007ffc61e25a20 RCX: 00007=
fbf3e61a75b
> [ 4549.904549] RDX: 0000000000000000 RSI: 00007fbf2f7ff150 RDI: 00007=
fbf2f7fc190
> [ 4549.904550] RBP: 00007ffc61e259d0 R08: 00000000ffffffff R09: 00000=
00000000000
> [ 4549.904551] R10: 00007ffc61e25c00 R11: 0000000000000246 R12: 00000=
000ffffff9c
> [ 4549.904552] R13: 00000000ffffff9c R14: 00000000016afab0 R15: 00007=
fbf30ef0810
> [ 4549.904555]  </TASK>
> [ 4549.904556] INFO: task kworker/u64:0:4372 blocked for more than 12=
2 seconds.
> [ 4549.912477]       Not tainted 5.15.164 #1-NixOS
> [ 4549.917573] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4549.926373] task:kworker/u64:0   state:D stack:    0 pid: 4372 ppi=
d:     2 flags:0x00004000
...
> [ 4549.926454]  </TASK>
> [ 4549.926459] INFO: task rsync:4929 blocked for more than 122 second=
s.
> [ 4549.933603]       Not tainted 5.15.164 #1-NixOS
> [ 4549.938702] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4549.947501] task:rsync           state:D stack:    0 pid: 4929 ppi=
d:  4925 flags:0x00000000
...
> [ 4549.947923]  xfs_alloc_ag_vextent_near.constprop.0+0x3f2/0x4a0 [xf=
s]
...
0000000000000052
> [ 4549.948366] RAX: ffffffffffffffda RBX: 00007ffe3909c8f0 RCX: 00007=
fcc5520c1d7
> [ 4549.948367] RDX: 0000000000000000 RSI: 00007ffe3909c8f0 RDI: 00007=
ffe3909e8f0
> [ 4549.948368] RBP: 00007ffe3909e8f0 R08: 0000000000000000 R09: 00007=
ffe3909c2f8
> [ 4549.948369] R10: 00007ffe3909c2f7 R11: 0000000000000246 R12: 00000=
00000000000
> [ 4549.948370] R13: 00000000023c9c30 R14: 00000000000081a4 R15: 00000=
00000000004
> [ 4549.948373]  </TASK>
> [ 4549.948374] INFO: task kworker/u64:1:4930 blocked for more than 12=
2 seconds.
> [ 4549.956299]       Not tainted 5.15.164 #1-NixOS
> [ 4549.961396] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4549.970198] task:kworker/u64:1   state:D stack:    0 pid: 4930 ppi=
d:     2 flags:0x00004000
...
> [ 4549.970282]  </TASK>
> [ 4549.970284] INFO: task kworker/u64:2:4949 blocked for more than 12=
3 seconds.
> [ 4549.978205]       Not tainted 5.15.164 #1-NixOS
> [ 4549.983290] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4549.992088] task:kworker/u64:2   state:D stack:    0 pid: 4949 ppi=
d:     2 flags:0x00004000
...
> [ 4549.992172]  </TASK>
> [ 4549.992174] INFO: task kworker/u64:5:4952 blocked for more than 12=
3 seconds.
> [ 4550.000095]       Not tainted 5.15.164 #1-NixOS
> [ 4550.005187] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4550.013985] task:kworker/u64:5   state:D stack:    0 pid: 4952 ppi=
d:     2 flags:0x00004000
...
> [ 4550.014058]  </TASK>
> [ 4550.014059] INFO: task kworker/u64:8:4954 blocked for more than 12=
3 seconds.
> [ 4550.021982]       Not tainted 5.15.164 #1-NixOS
> [ 4550.027078] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4550.035881] task:kworker/u64:8   state:D stack:    0 pid: 4954 ppi=
d:     2 flags:0x00004000
...
> [ 4550.035957]  </TASK>
> [ 4550.035958] INFO: task kworker/u64:9:4955 blocked for more than 12=
3 seconds.
> [ 4550.043881]       Not tainted 5.15.164 #1-NixOS
> [ 4550.048979] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> [ 4550.057786] task:kworker/u64:9   state:D stack:    0 pid: 4955 ppi=
d:     2 flags:0x00004000
...
>> On 7. Aug 2024, at 08:46, Christian Theune <ct@flyingcircus.io> wrot=
e:
>>=20
>> I tried updating to 5.15.164, but have to struggle against our confi=
g management as some options have been shifted that I need to filter ou=
t: NFSD_V3 and NFSD2_ACL are now fixed and cause config errors if set -=
 I guess that=E2=80=99s a valid thing to happen within an LTS release. =
I=E2=80=99ll try again on Friday
>>=20
>>> On 7. Aug 2024, at 07:31, Christian Theune <ct@flyingcircus.io> wro=
te:
>>>=20
>>> Sure,
>>>=20
...
>>>>> we are seeing an issue that can be triggered with relative ease o=
n a server that has been working fine for a few weeks. The regular work=
load is a backup utility that copies off data from virtual disk images =
in 4MiB (compressed) chunks from Ceph onto a local NVME-based RAID-6 ar=
ray that is encrypted using LUKS.
...
data and we=E2=80=99ve seen the server suddenly lock up twice. Any IO t=
hat interacts with the mountpoint (/srv/backy) will hang indefinitely. =
A reset is required to get out of this as the machine will hang trying =
to unmount the affected filesystem. No other messages than the hung tas=
ks are being presented - I have no indicator for hardware faults at the=
 moment.
...
>>>>=20
>>>> Since you can trigger this easily, I'll suggest you to try the lat=
est
...
>> --=20
>> Christian Theune =C2=B7 ct@flyingcircus.io =C2=B7 +49 345 219401 0
>> Flying Circus Internet Operations GmbH =C2=B7 https://flyingcircus.i=
o
>> Leipziger Str. 70/71 =C2=B7 06108 Halle (Saale) =C2=B7 Deutschland
>> HR Stendal HRB 21169 =C2=B7 Gesch=C3=A4ftsf=C3=BChrer: Christian The=
une, Christian Zagrodnick
>>=20
