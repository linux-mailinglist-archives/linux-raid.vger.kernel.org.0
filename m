...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 984A07DF84D
	for <lists+linux-raid@lfdr.de>; Thu,  2 Nov 2023 18:06:00 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229458AbjKBRF6 (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Thu, 2 Nov 2023 13:05:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57398 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234506AbjKBRF5 (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Thu, 2 Nov 2023 13:05:57 -0400
Received: from mail-io1-xd34.google.com (mail-io1-xd34.google.com [IPv6:2607:f8b0:4864:20::d34])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 80597123
        for <linux-raid@vger.kernel.org>; Thu,  2 Nov 2023 10:05:53 -0700 (PDT)
Received: by mail-io1-xd34.google.com with SMTP id ca18e2360f4ac-7a94de8c70cso41967039f.3
        for <linux-raid@vger.kernel.org>; Thu, 02 Nov 2023 10:05:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1698944753; x=1699549553; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=mYGXgXyJGMp3YbL7jRG/m7cSVFJ+79VIEpLrh5k5kqk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698944753; x=1699549553;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=mYGXgXyJGMp3YbL7jRG/m7cSVFJ+79VIEpLrh5k5kqk=;
        b=
X-Gm-Message-State: AOJu0YzHlNnh1CeKIMu1kE2jq5PM0CvCo2b3pSHycbDJK1NbpFS90rEX
        VEMgol5NLUL4cVLPlk7T9vixKYV3xjaK0hwAQJY+Y4/B
X-Google-Smtp-Source: AGHT+IEZU5TuQGfa2k7c68ifrmfmhmr5wolZAxKu9syVF/me2dRw0b+g0zx+2A2mvxL2RnGnoGEcOvEgSQTT04DTfSE=
X-Received: by 2002:a05:6602:3404:b0:7a6:6d0e:af6e with SMTP id
 n4-20020a056602340400b007a66d0eaf6emr23740982ioz.10.1698944752459; Thu, 02
 Nov 2023 10:05:52 -0700 (PDT)
MIME-Version: 1.0
References: <87273fc6-9531-4072-ae6c-06306e9a269d@eyal.emu.id.au>
 ...
 <CAAMCDecMvSN9KnNhu3QyRQah016uJhg_vXtjO90WECBCMr8W9w@mail.gmail.com> <1b453db1-b260-4e0b-978e-f15928d10151@eyal.emu.id.au>
In-Reply-To: <1b453db1-b260-4e0b-978e-f15928d10151@eyal.emu.id.au>
From:   Roger Heflin <rogerheflin@gmail.com>
Date:   Thu, 2 Nov 2023 12:05:41 -0500
Message-ID: <CAAMCDec1acjdpVx0qPqQWhDCpAVmMQP-g8tMGc4-iXPbNZV6kg@mail.gmail.com>
...
On Thu, Nov 2, 2023 at 8:06=E2=80=AFAM <eyal@eyal.emu.id.au> wrote:
>
...
>
> I do have iostat running on the components too, and the writing mostly re=
flects what md127 sees.
> However, while there are no reads on md127, there is often some on the co=
mponents,
> very visible in the last two iostat minutes. Is there some RUW going, on =
the components?
>
...
>
> ## iostat
> 23:05:08 Device             tps    kB_read/s    kB_wrtn/s    kB_dscd/s   =
 kB_read    kB_wrtn    kB_dscd
> 23:05:08 md127             2.22         0.00        14.73         0.00   =
       0        884          0
> 23:05:08 sdb               1.13         1.93        12.10         0.00   =
     116        726          0
> 23:05:08 sdc               1.32         0.00        16.17         0.00   =
       0        970          0
> 23:05:08 sdd               1.18         0.00         5.57         0.00   =
       0        334          0
> 23:05:08 sde               0.83         0.00         1.50         0.00   =
       0         90          0
> 23:05:08 sdf               0.83         0.00         1.50         0.00   =
       0         90          0
> 23:05:08 sdg               1.27         4.47         5.97         0.00   =
     268        358          0
>
> 23:06:08 Device             tps    kB_read/s    kB_wrtn/s    kB_dscd/s   =
 kB_read    kB_wrtn    kB_dscd
> 23:06:08 md127             2.75         0.00        36.20         0.00   =
       0       2172          0
> 23:06:08 sdb               1.30         4.47        22.40         0.00   =
     268       1344          0
> 23:06:08 sdc               1.13         0.00        14.40         0.00   =
       0        864          0
> 23:06:08 sdd               1.13         0.80        14.20         0.00   =
      48        852          0
> 23:06:08 sde               0.82         8.53         9.73         0.00   =
     512        584          0
> 23:06:08 sdf               0.87         8.53         7.13         0.00   =
     512        428          0
> 23:06:08 sdg               0.75         8.53         1.20         0.00   =
     512         72          0
>
> 23:07:08 Device             tps    kB_read/s    kB_wrtn/s    kB_dscd/s   =
 kB_read    kB_wrtn    kB_dscd
> 23:07:08 md127             2.30         0.00        10.93         0.00   =
       0        656          0
> 23:07:08 sdb               1.17         2.13         5.82         0.00   =
     128        349          0
> 23:07:08 sdc               1.12         0.00         5.35         0.00   =
       0        321          0
> 23:07:08 sdd               1.35         4.33         9.68         0.00   =
     260        581          0
> 23:07:08 sde               1.00         4.33         5.68         0.00   =
     260        341          0
> 23:07:08 sdf               0.82         0.00         3.95         0.00   =
       0        237          0
> 23:07:08 sdg               1.00         4.33         5.68         0.00   =
     260        341          0
>
> 23:08:08 Device             tps    kB_read/s    kB_wrtn/s    kB_dscd/s   =
 kB_read    kB_wrtn    kB_dscd
> 23:08:08 md127            13.55         0.13       238.73         0.00   =
       8      14324          0
> 23:08:08 sdb               1.92        36.47        72.25         0.00   =
    2188       4335          0
> 23:08:08 sdc               1.78        27.67        66.38         0.00   =
    1660       3983          0
> 23:08:08 sdd               2.25        47.67        95.52         0.00   =
    2860       5731          0
> 23:08:08 sde               2.03        43.87        77.72         0.00   =
    2632       4663          0
> 23:08:08 sdf               1.73        49.20        59.65         0.00   =
    2952       3579          0
> 23:08:08 sdg               1.72        29.80        56.45         0.00   =
    1788       3387          0
>
> 23:09:08 Device             tps    kB_read/s    kB_wrtn/s    kB_dscd/s   =
 kB_read    kB_wrtn    kB_dscd
> 23:09:08 md127             3.22         0.00        59.47         0.00   =
       0       3568          0
> 23:09:08 sdb               1.88        26.60        36.00         0.00   =
    1596       2160          0
> 23:09:08 sdc               1.82        32.53        13.60         0.00   =
    1952        816          0
> 23:09:08 sdd               1.83        17.07        41.80         0.00   =
    1024       2508          0
> 23:09:08 sde               1.10         9.07        33.40         0.00   =
     544       2004          0
> 23:09:08 sdf               0.93        21.93         3.80         0.00   =
    1316        228          0
> 23:09:08 sdg               0.90        15.20         6.73         0.00   =
     912        404          0
>
...
>
> My experience is that the array can handle all of this easily, and I neve=
r noticed
> any hiccups.
>
...
>
> What I see here is that a few seconds of usual work take a few hours to p=
erform.
> This does not look like the array is stressed, something more substantial=
 is going on.
>
...
> >>> Hi list,
> >>>
> >>> for the record, I do not think that any of the observations the OP ma=
de can be
> >>> explained by non-pathological phenomena/patterns of behavior. Somethi=
ng is
> >>> very clearly wrong with how this system behaves (the reported figures=
 do not
> >>> at all match the expected performance of even a degraded RAID6 array =
in my
> >>> experience) and how data written to the filesystem apparently fails t=
o make it
> >>> into the backing devices in acceptable time.
> >>>
> >>> The whole affair reeks either of "subtle kernel bug", or maybe "subtl=
e
> >>> hardware failure", I think.
> >>>
> >>> Still, it'd be interesting to know what happens when writes to the ar=
ray thru
> >>> the file system are performed with O_DIRECT in effect, i.e., using `d=
d
> >>> oflag=3Ddirect status=3Dprogress ...` - does this yield any observabl=
e (via
> >>> `iostat` et al.) thruput to the disks beneath? What transfer speeds d=
oes `dd`
> >>> report this way with varying block sizes? Are there no concerning mes=
sages in
> >>> the debug ringbuffer (`dmesg`) at this time?
> >>>
> >>> I'm not sure how we'd best learn more about what the participating bu=
sy kernel
> >>> threads (Fedora 38 might have more convenient devices up its sleeve t=
han
> >>> ftrace?) are spending their time on in particular, but I think that's=
 what's
> >>> needed to be known to pin down the underlying cause of the problem.
> >>
> >> To clarify what may be lost on this thread.
> >>
> >> I can dd to this fs just fine, The Dirty count does not go above about=
 4GB. The machine has 32KB.
...
> >> When killed less than 3GB were copied. Mostly small files in many dire=
ctories.
...
E+ COMMAND
> >> 1491995 root      20   0       0      0      0 R  97.3   0.0  12:50.67=
 kworker/u16:2+flush-9:127
> >>
> >> And iostat of md127 shows slow writing like this:
> >>            Device             tps    kB_read/s    kB_wrtn/s    kB_dscd=
/s    kB_read    kB_wrtn    kB_dscd
...
> >>
> >> BTW, if I try to shutdown in this situation, it will get stuck, and if=
 I force a sysrq boot I get
> >> an array of all spares on restart. At least this is what happened twic=
e already.
> >>
> >> HTH
> >>
