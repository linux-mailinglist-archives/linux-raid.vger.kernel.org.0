Return-Path: <linux-raid+bounces-4869-lists+linux-raid=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-raid@lfdr.de
Delivered-To: lists+linux-raid@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id C05D1B274AE
	for <lists+linux-raid@lfdr.de>; Fri, 15 Aug 2025 03:26:05 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7166FA27D90
	for <lists+linux-raid@lfdr.de>; Fri, 15 Aug 2025 01:26:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 96EA91339A4;
	Fri, 15 Aug 2025 01:25:59 +0000 (UTC)
X-Original-To: linux-raid@vger.kernel.org
Received: from dggsgout11.his.huawei.com (dggsgout11.his.huawei.com [45.249.212.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3E0D58821;
	Fri, 15 Aug 2025 01:25:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1755221159; cv=none; b=XBgvtChkT5JzcXPHrRt5V07pul/RBZexq9xDgKA/67wTya6eXrbxaYIU5G/kYqhNq3NhNPHiFuf3pqFHw1LH2iMBZ3yWkqLcgKsmYotvwxHA5XLTgqRiALDnswijDMDCbd4/+e3IZI3scwpv8Sb4jxaMZFyiD477vz5sMb+z4QQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1755221159; c=relaxed/simple;
	bh=2AdYHaJXgy58NUiDgW+sZZiqNx+Pho+piaNp0S4Hhus=;
	h=Subject:To:Cc:References:From:Message-ID:Date:MIME-Version:
	 In-Reply-To:Content-Type; b=MmvU6410eLHfmXqoeCak1UUgiv9ud+x1KRTNf0M+J60mkm7hbJq9V8U5oBuvc2j263rliHwdqGU3tclGPDEIZMMGGyVmiWOdVnnmOyKG9jL1U9MFaprYvXoMh4Xus/5f69zRXVhR1CeQNt00RZZlHrxmMlHeZ4JKE7uo8/yll+o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com; spf=pass smtp.mailfrom=huaweicloud.com; arc=none smtp.client-ip=45.249.212.51
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huaweicloud.com
Received: from mail.maildlp.com (unknown [172.19.163.216])
	by dggsgout11.his.huawei.com (SkyGuard) with ESMTPS id 4c33td0hS4zYQvBG;
	Fri, 15 Aug 2025 09:10:01 +0800 (CST)
Received: from mail02.huawei.com (unknown [10.116.40.128])
	by mail.maildlp.com (Postfix) with ESMTP id B24AD1A17CF;
	Fri, 15 Aug 2025 09:09:59 +0800 (CST)
Received: from [10.174.179.143] (unknown [10.174.179.143])
	by APP4 (Coremail) with SMTP id gCh0CgDnYhPliJ5oLK7dDg--.26477S3;
	Fri, 15 Aug 2025 09:09:58 +0800 (CST)
...
References: <20250722033340.1933388-1-linan666@huaweicloud.com>
 <CALTww2-kHxa5FsPWXURwvv0q_kps875Bmecs6OjtO0AdY_V8Fg@mail.gmail.com>
From: Yu Kuai <yukuai1@huaweicloud.com>
Message-ID: <8bfafadf-210b-9c3d-a03f-dc4e6f877b43@huaweicloud.com>
Date: Fri, 15 Aug 2025 09:09:57 +0800
...
MIME-Version: 1.0
In-Reply-To: <CALTww2-kHxa5FsPWXURwvv0q_kps875Bmecs6OjtO0AdY_V8Fg@mail.gmail.com>
Content-Type: text/plain; charset=utf-8; format=flowed
Content-Transfer-Encoding: 8bit
X-CM-TRANSID:gCh0CgDnYhPliJ5oLK7dDg--.26477S3
X-Coremail-Antispam: 1UD129KBjvAXoWfXryDGrWDKr43tw17GF1kuFg_yoW5ZFW7Zo
	Zakr1Ivw4rGr1fWrn3tryUta9xWas8Jw4Yyw15ZrZ8Zr1q9w4UJrn3WrW7XF15tF9Iga4x
	W3sYgry8ZFW7C393n29KB7ZKAUJUUUU8529EdanIXcx71UUUUU7v73VFW2AGmfu7bjvjm3
...
在 2025/08/14 23:19, Xiao Ni 写道:
> Hi all
> 
> mdadm build fails because of this change.
> 
> super0.c: In function ‘update_super0’:
> super0.c:672:19: error: ‘mdp_super_t’ {aka ‘struct mdp_superblock_s’}
> has no member named ‘recovery_cp’
>    672 |                 sb->recovery_cp = 0;
>        |                   ^~
> 
...
> Xiao
> 
I think it's fine to revert the change to mdp_super_t, and keep the
change inside mddev.

Thanks,
Kuai

> On Tue, Jul 22, 2025 at 11:40 AM <linan666@huaweicloud.com> wrote:
>>
