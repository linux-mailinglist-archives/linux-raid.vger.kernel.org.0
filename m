...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CDE44B8F7D
	for <lists+linux-raid@lfdr.de>; Fri, 20 Sep 2019 14:09:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2408846AbfITMJX (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Fri, 20 Sep 2019 08:09:23 -0400
Received: from mtax.cdmx.gob.mx ([187.141.35.197]:8322 "EHLO mtaw.cdmx.gob.mx"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S2408844AbfITMJX (ORCPT <rfc822;linux-raid@vger.kernel.org>);
        Fri, 20 Sep 2019 08:09:23 -0400
X-NAI-Header: Modified by McAfee Email Gateway (4500)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=cdmx.gob.mx; s=72359050-3965-11E6-920A-0192F7A2F08E;
        t=1568965841; h=X-Virus-Scanned:Content-Type:
        ...
        8BPhtqdzKUJiGtXCGJ3YtSNOM=; b=D1Rij3OIklquhEq4L9A0
        jF60RIzBNZ0kM6rmRuOBQq/I6nhfGiU1qLrcNekfqNfGLkLQvg
        YkhYJ7GVyu5hhQk7nPXOXi3omeLHPgxxr2EIUl8j6N+q3OXDc0
        wYLukdcJqkXgrsVpi4Z37GQVLWjVEjTHDePwClpX4Rhd9ljkzm
        c=
Received: from correo.seciti.cdmx.gob.mx (gdf-correo.cdmx.gob.mx [10.250.102.17]) by mtaw.cdmx.gob.mx with smtp
         id 0865_6b75_1f1aae4f_321f_424f_a232_705b6cbb240c;
        Fri, 20 Sep 2019 02:50:41 -0500
Received: from localhost (localhost [127.0.0.1])
        by gdf-correo.df.gob.mx (Postfix) with ESMTP id F3B8E2E18;
        Fri, 20 Sep 2019 02:50:39 -0500 (CDT)
Received: from correo.seciti.cdmx.gob.mx ([127.0.0.1])
        by localhost (gdf-correo.df.gob.mx [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id H_wl0w9t3wk0; Fri, 20 Sep 2019 02:50:39 -0500 (CDT)
Received: from localhost (localhost [127.0.0.1])
        by gdf-correo.df.gob.mx (Postfix) with ESMTP id B6D403381;
        Fri, 20 Sep 2019 02:50:39 -0500 (CDT)
X-Virus-Scanned: amavisd-new at gdf-correo.df.gob.mx
Received: from correo.seciti.cdmx.gob.mx ([127.0.0.1])
        by localhost (gdf-correo.df.gob.mx [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id WSg7LzCIT84U; Fri, 20 Sep 2019 02:50:39 -0500 (CDT)
Received: from [100.80.130.141] (8ta-250-0-23.telkomadsl.co.za [102.250.0.23])
        by gdf-correo.df.gob.mx (Postfix) with ESMTPSA id 89653330A;
        Fri, 20 Sep 2019 02:50:30 -0500 (CDT)
...
Date:   Fri, 20 Sep 2019 09:50:35 +0200
Reply-To: "shanemissler.spende11@gmail.comshanemissler.spende11"@gmail.com
Message-Id: <20190920075030.89653330A@gdf-correo.df.gob.mx>
...
X-SAAS-TrackingID: 1d4848d5.0.86269984.00-2380.145022724.s12p02m016.mxlogic.net
