Return-Path: <linux-raid+bounces-4585-lists+linux-raid=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-raid@lfdr.de
Delivered-To: lists+linux-raid@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 98A47AFC47C
	for <lists+linux-raid@lfdr.de>; Tue,  8 Jul 2025 09:48:40 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id AD4E43BF05C
	for <lists+linux-raid@lfdr.de>; Tue,  8 Jul 2025 07:48:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 72561224AFC;
	Tue,  8 Jul 2025 07:48:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="0UZqO6Ct";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="3U9pDHWG";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="0UZqO6Ct";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="3U9pDHWG"
...
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.223.130])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6A92FF510
	for <linux-raid@vger.kernel.org>; Tue,  8 Jul 2025 07:48:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.135.223.130
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1751960913; cv=none; b=Yaf6ULMmvqgaiyCZi9RnpxNfy6ZykzCCr+4hKTaFEPKpaOZ7Z39u0FtbkBsx//io7dT4ynisax9yFtCBgQa0e7Jeff0++NiRC3uf8ZfZEOWr0t9qC1iPEEgujXq/tEZ8pC4kF6LDGWtXJ2mi+Hu9fe8K6nY1ZFdKa026XUKf8sA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1751960913; c=relaxed/simple;
	bh=tB/718PFb7ONFqD7wSZYHGHhf4FGY5EVjaUxeVfCVFc=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=VC188jdFyZkayNiM3q9WmuClGFBCiJTiR9ze3xTJs0Lv2CI6pbxDKKYk9QOx5vs0mEPsRtkkWyAHuRvY50hG6U5x2/mUUcf7+GK6INRPthAbSWJXTeCSV7IbYhi0sYymqA53lyaRuQdj9Socm6Fsegxwy9Hc+N+sK97t10CYy6I=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=suse.de; spf=pass smtp.mailfrom=suse.de; dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b=0UZqO6Ct; dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b=3U9pDHWG; dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b=0UZqO6Ct; dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b=3U9pDHWG; arc=none smtp.client-ip=195.135.223.130
...
Received: from imap1.dmz-prg2.suse.org (imap1.dmz-prg2.suse.org [IPv6:2a07:de40:b281:104:10:150:64:97])
	...
	(No client certificate requested)
	by smtp-out1.suse.de (Postfix) with ESMTPS id 5DC3121160;
	Tue,  8 Jul 2025 07:48:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
	t=1751960907; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=aQmbMDE0y19r1+c67tjx7eHhcFAZ4whGVpJ6I7Ekey8=;
	b=0UZqO6CtvSLRN4lcrGtojlbGdOge2p1IVykGSAL4ZSu6ZXZKknq2WrkxZGUwMmzkrjPxOP
	ltBQ9YVtpfY8inFg9VUrqzcyql/xY1F6VnnlspndwlLecDvMPh791GvEmlaBm5GDUQS00a
	iigicwP7gUt8sUG03hzDubAZXobu2GY=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
	s=susede2_ed25519; t=1751960907;
	h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=aQmbMDE0y19r1+c67tjx7eHhcFAZ4whGVpJ6I7Ekey8=;
	b=3U9pDHWGyOe+gOrSzlUJjZ/qx80plKOQipujtfG2KVIsGWA+1IiqPEih81fRyicVOW2X6J
	0JyA0U3m9icFuUAg==
Authentication-Results: smtp-out1.suse.de;
	dkim=pass header.d=suse.de header.s=susede2_rsa header.b=0UZqO6Ct;
	dkim=pass header.d=suse.de header.s=susede2_ed25519 header.b=3U9pDHWG
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
	t=1751960907; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 0C4AB13A54;
	Tue,  8 Jul 2025 07:48:27 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
	by imap1.dmz-prg2.suse.org with ESMTPSA
	id S8U/AkvNbGhaSgAAD6G6ig
	(envelope-from <hare@suse.de>); Tue, 08 Jul 2025 07:48:27 +0000
Message-ID: <a0ae5ea4-513e-40f0-9421-2bec57e1ee89@suse.de>
Date: Tue, 8 Jul 2025 09:47:59 +0200
Precedence: bulk
...
In-Reply-To: <20250707165202.11073-12-yukuai@kernel.org>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
X-Spam-Level: 
X-Spam-Flag: NO
X-Rspamd-Queue-Id: 5DC3121160
