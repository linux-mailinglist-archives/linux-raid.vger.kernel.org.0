Return-Path: <linux-raid+bounces-3546-lists+linux-raid=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-raid@lfdr.de
Delivered-To: lists+linux-raid@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E3213A1D2B8
	for <lists+linux-raid@lfdr.de>; Mon, 27 Jan 2025 09:59:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 361651888833
	for <lists+linux-raid@lfdr.de>; Mon, 27 Jan 2025 08:59:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7A3391FDA92;
	Mon, 27 Jan 2025 08:58:22 +0000 (UTC)
X-Original-To: linux-raid@vger.kernel.org
Received: from dggsgout11.his.huawei.com (dggsgout11.his.huawei.com [45.249.212.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C3C541FC7FF;
	Mon, 27 Jan 2025 08:58:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1737968302; cv=none; b=IhX1eOPA+Ru5v/5DMjiOdJMzpbt9X7M5QS6v5AepP6dUsKHtD++Dztsi6K8yZHdlcr2u4oiYPphPM8i4rJjv4SffmyIr6k+SkTp95pXgfeXcmElYOSxSTeiPBGh3VFX22vA1YQP+pmi5WRRLaS4fAmQ73UF+vatMrtEl0Nd1BNQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1737968302; c=relaxed/simple;
	bh=OopqUzPMWaYDUBSDPwv3uuP3M+byAlVD0mZcWUJiofA=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=Dnm2F2gPm+MdkzrzkcniMVtWeawWRXueoKYpX8zUuRMPqE6wHgZUiGnu9c65PpR2TC6pVyw+ALVG7k7Gg/oUshjgy0pdG8NROf0pu60rWUmqnYMEzzzT0Ci2hH3G6W5zjoS7E/0qDBw/0MGepi465124fv1Q2OjSagCXDfvHW3k=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com; spf=none smtp.mailfrom=huaweicloud.com; arc=none smtp.client-ip=45.249.212.51
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=huaweicloud.com
Received: from mail.maildlp.com (unknown [172.19.93.142])
	by dggsgout11.his.huawei.com (SkyGuard) with ESMTP id 4YhMkx0DTtz4f3jqx;
	Mon, 27 Jan 2025 16:58:01 +0800 (CST)
Received: from mail02.huawei.com (unknown [10.116.40.128])
	by mail.maildlp.com (Postfix) with ESMTP id 976451A07C0;
	Mon, 27 Jan 2025 16:58:16 +0800 (CST)
Received: from huaweicloud.com (unknown [10.175.104.67])
	by APP4 (Coremail) with SMTP id gCh0CgAXe1+mSpdnShB+CA--.53281S6;
	Mon, 27 Jan 2025 16:58:16 +0800 (CST)
...
Subject: [PATCH 6.12 2/5] md/md-bitmap: remove the last parameter for bimtap_ops->endwrite()
Date: Mon, 27 Jan 2025 16:52:11 +0800
Message-Id: <20250127085214.3197761-3-yukuai1@huaweicloud.com>
...
X-CM-TRANSID:gCh0CgAXe1+mSpdnShB+CA--.53281S6
X-Coremail-Antispam: 1UD129KBjvAXoW3tFyUAr1rZw4fKFWDtrW3Awb_yoW8JrW3uo
	...
	AIcVC2z280aVCY1x0267AKxVW8JVW8JrUvcSsGvfC2KfnxnUUI43ZEXa7sR_jXHtUUUUU=
	=
...
index 94d50ee8d9b9..85521579203c 100644
...
-			set_bit(R1BIO_Degraded, &r1_bio->state);
 			...
 			to_put = bio;
@@ -1493,11 +1490,8 @@ static void raid1_write_request(struct mddev *mddev, struct bio *bio,
 			break;
 		}
 		r1_bio->bios[i] = NULL;
...
@@ -1523,16 +1517,6 @@ static void raid1_write_request(struct mddev *mddev, struct bio *bio,
 					 */
...
-				 */
 			...
 			if (is_bad) {
@@ -2569,12 +2553,10 @@ static void handle_write_finished(struct r1conf *conf, struct r1bio *r1_bio)
 			 * errors.
 			 */
 			fail = true;
...
@@ -2665,8 +2647,6 @@ static void raid1d(struct md_thread *thread)
...
index 80873bd65851..f6aa56a7d400 100644
...
-				set_bit(R10BIO_Degraded, &r10_bio->state);
 				...
 				to_put = bio;
 				dec_rdev = 1;
@@ -1429,10 +1427,8 @@ static void raid10_write_request(struct mddev *mddev, struct bio *bio,
...
@@ -1449,14 +1445,6 @@ static void raid10_write_request(struct mddev *mddev, struct bio *bio,
...
-				 */
 			...
 			if (is_bad) {
@@ -2908,11 +2896,8 @@ static void handle_write_completed(struct r10conf *conf, struct r10bio *r10_bio)
...
@@ -2971,8 +2956,6 @@ static void raid10d(struct md_thread *thread)
...
index d08d64ae7bc0..4482e1b1e4e3 100644
...
-		clear_bit(STRIPE_DEGRADED, &sh->state);
 		...
 		set_bit(STRIPE_INSYNC, &sh->state);
 		break;
@@ -4900,7 +4892,6 @@ static void break_stripe_batch_list(struct stripe_head *head_sh,
...
index 896ecfc4afa6..538843123d92 100644
