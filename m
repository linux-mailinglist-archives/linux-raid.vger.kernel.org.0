...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4B7BF76F050
	for <lists+linux-raid@lfdr.de>; Thu,  3 Aug 2023 19:09:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234177AbjHCRJL (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Thu, 3 Aug 2023 13:09:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32916 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233985AbjHCRJK (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Thu, 3 Aug 2023 13:09:10 -0400
Received: from mailbox.box.xen0n.name (mail.xen0n.name [115.28.160.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C7F1435B0;
        Thu,  3 Aug 2023 10:09:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=xen0n.name; s=mail;
        t=1691082546; bh=T5rQ9BO20/3cqL6c0WAUB+h7He7LtLc8XAN9qYPfAFQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=CTp69WwTli2igOdsFSXW9uQOZi7Iyx1203rtD1LzsLM8QzXJT2v1sdmIpqnQL72Xk
         Yz2hGBDyNdrqq8YQCF2go3D5ZcbucJyzs2/yQB9yKAmmoM/dXuny/W84mg4rqgBD8i
         VH2kP09b/7HcGgtFFWHoBDvcJRKv9yjpBgQJ1c7o=
Received: from ld50.lan (unknown [101.88.28.229])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
        (No client certificate requested)
        by mailbox.box.xen0n.name (Postfix) with ESMTPSA id 1C5E06019D;
        Fri,  4 Aug 2023 01:09:05 +0800 (CST)
From:   WANG Xuerui <kernel@xen0n.name>
To:     Song Liu <song@kernel.org>
Cc:     Huacai Chen <chenhuacai@kernel.org>, linux-raid@vger.kernel.org,
        loongarch@lists.linux.dev, linux-kernel@vger.kernel.org,
        WANG Xuerui <git@xen0n.name>
Subject: [PATCH v2 2/3] raid6: Add LoongArch SIMD syndrome calculation
Date:   Fri,  4 Aug 2023 01:08:57 +0800
Message-Id: <20230803170858.781245-3-kernel@xen0n.name>
