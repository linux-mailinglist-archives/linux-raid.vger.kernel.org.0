...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 66B317795AF
	for <lists+linux-raid@lfdr.de>; Fri, 11 Aug 2023 19:07:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236281AbjHKRHY (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Fri, 11 Aug 2023 13:07:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40990 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236441AbjHKRHW (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Fri, 11 Aug 2023 13:07:22 -0400
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.220.28])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0125D26B6;
        Fri, 11 Aug 2023 10:07:20 -0700 (PDT)
Received: from relay2.suse.de (relay2.suse.de [149.44.160.134])
        by smtp-out1.suse.de (Postfix) with ESMTP id B44BB2188B;
        Fri, 11 Aug 2023 17:07:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1691773638; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=EukBQh59BSHnuc4vkjbXqXwtPt4S033knCkIHMcAUBc=;
        b=0z8TcGlk/Gdd6J+oMezsrFqJ96//qnae7rGOmMKjQVLKc7Mt/K5lCOTbxw/P6AdAr/kA91
        YTO7c8jYytJUwq6hEYTEDbLwprrsXlUlkA6hIbHBsSUALYnEnlKERIn3v2qjMcw8TWTQ5/
        jXspDdjNUQKrv/Nw15XkZSIqSxohxlU=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1691773638;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=EukBQh59BSHnuc4vkjbXqXwtPt4S033knCkIHMcAUBc=;
        b=+G3Tk+bZUDOgAo/9zdjmPVhm7NfXxcZJek6AqvRXHiMuM/AWLDZtuKc/oxmugu5YtZbsQZ
        D3hJsufhDogMsNAw==
Received: from localhost.localdomain (colyli.tcp.ovpn1.nue.suse.de [10.163.16.22])
        by relay2.suse.de (Postfix) with ESMTP id 916652C142;
...
Subject: [PATCH v7 3/6] badblocks: improve badblocks_set() for multiple ranges handling
Date:   Sat, 12 Aug 2023 01:05:09 +0800
Message-Id: <20230811170513.2300-4-colyli@suse.de>
