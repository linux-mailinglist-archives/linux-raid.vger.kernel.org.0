...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7B7FD210717
	for <lists+linux-raid@lfdr.de>; Wed,  1 Jul 2020 11:01:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729364AbgGAJBC (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Wed, 1 Jul 2020 05:01:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55936 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729230AbgGAJAS (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Wed, 1 Jul 2020 05:00:18 -0400
Received: from casper.infradead.org (casper.infradead.org [IPv6:2001:8b0:10b:1236::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 08BB8C061755;
        Wed,  1 Jul 2020 02:00:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=casper.20170209; h=Content-Transfer-Encoding:MIME-Version:
        References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender:Reply-To:
        Content-Type:Content-ID:Content-Description;
        bh=URaf5h3Vltw7cp+VhmMz6d5PfFEfEIzC9ReUXZBzNZE=; b=DRlcLd3IOwNR11GB9y9oWJzbON
        ;
Received: from [2001:4bb8:184:76e3:ea38:596b:3e9e:422a] (helo=localhost)
        by casper.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1jqYbF-0008G7-11; Wed, 01 Jul 2020 09:00:14 +0000
...
Subject: [PATCH 16/20] block: move ->make_request_fn to struct block_device_operations
Date:   Wed,  1 Jul 2020 10:59:43 +0200
Message-Id: <20200701085947.3354405-17-hch@lst.de>
...
index dbadb7defd618a..948987e9b6ab3e 100644
--- a/block/blk-mq.c
+++ b/block/blk-mq.c
...
index 0114fd92c8a05b..9dcf51c94096a7 100644
--- a/block/blk.h
+++ b/block/blk.h
...
index faa340b70123b1..23230c1d031e0a 100644
