...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 320407795B2
	for <lists+linux-raid@lfdr.de>; Fri, 11 Aug 2023 19:07:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235983AbjHKRHe (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Fri, 11 Aug 2023 13:07:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40990 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236501AbjHKRHc (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Fri, 11 Aug 2023 13:07:32 -0400
Received: from smtp-out2.suse.de (smtp-out2.suse.de [IPv6:2001:67c:2178:6::1d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5E84E30DD;
        Fri, 11 Aug 2023 10:07:30 -0700 (PDT)
Received: from relay2.suse.de (relay2.suse.de [149.44.160.134])
        by smtp-out2.suse.de (Postfix) with ESMTP id 1D6201F8A6;
        Fri, 11 Aug 2023 17:07:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1691773649; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=MRS8ilc2ltmmc+pq2LhpSBeOtAXZRE6Zp7zdB3DRkaE=;
        b=NHBt8rVa5cTvq6v/0vysm5jyEn7Dc/JSjFOddtRgexCy81pvp8G9E4B6Rs2ZgishiZp4Z2
        hn5D+qVFZ7zciFZu6Uug6aLK0R7bXlOUa9nEQTollvuGaF8ERkyG+c1tZ1QaVpQmAzk8Lq
        EX9cAFyUFSuUboGaJsvdRMctYLrF1eU=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1691773649;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=MRS8ilc2ltmmc+pq2LhpSBeOtAXZRE6Zp7zdB3DRkaE=;
        b=ZqxR6o33YnVxyTpxO2dHumJ/phvh+TD9LNttQpaHMohDx5EYdD7I3Nvqp/GE1zDfCz9BUM
        vyGE4N3tIvmzn+DA==
Received: from localhost.localdomain (colyli.tcp.ovpn1.nue.suse.de [10.163.16.22])
        by relay2.suse.de (Postfix) with ESMTP id 4C1592C142;
        Fri, 11 Aug 2023 17:07:19 +0000 (UTC)
...
Subject: [PATCH v7 4/6] badblocks: improve badblocks_clear() for multiple ranges handling
Date:   Sat, 12 Aug 2023 01:05:10 +0800
Message-Id: <20230811170513.2300-5-colyli@suse.de>
...
+ *   simpler.
 ...
 /*
@@ -946,6 +1063,214 @@ static int _badblocks_set(struct badblocks *bb, sector_t s, int sectors,
 	return rv;
 }
