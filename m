...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 60295793E52
	for <lists+linux-raid@lfdr.de>; Wed,  6 Sep 2023 16:05:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240200AbjIFOFp (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Wed, 6 Sep 2023 10:05:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55954 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232210AbjIFOFo (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Wed, 6 Sep 2023 10:05:44 -0400
Received: from mail-yb1-xb29.google.com (mail-yb1-xb29.google.com [IPv6:2607:f8b0:4864:20::b29])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C54A6BD
        for <linux-raid@vger.kernel.org>; Wed,  6 Sep 2023 07:05:37 -0700 (PDT)
Received: by mail-yb1-xb29.google.com with SMTP id 3f1490d57ef6-d7260fae148so3195602276.1
        for <linux-raid@vger.kernel.org>; Wed, 06 Sep 2023 07:05:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1694009137; x=1694613937; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Sh4duu0Rx1545JbByzR+i8wXObTzOT+AOkMZ5Fy3pBs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1694009137; x=1694613937;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Sh4duu0Rx1545JbByzR+i8wXObTzOT+AOkMZ5Fy3pBs=;
        b=
X-Gm-Message-State: AOJu0YzBetLIR8V14HEl2nGzZonUuA6kP341azUc8EQmpR6OgozNi936
        5G5kvnhJZ1Ql8PMYR/noK2KWCJS1ViEzGs+dsvuO2aKXwA==
X-Google-Smtp-Source: AGHT+IEw0CPXCHVjUgCUsDZiu073ByJT75lw890/pmChJtLNF4oqawJQ3hEvOEHH/LL7l6Ibf3zKZ1ttojaQe+GM0iI=
X-Received: by 2002:a25:688c:0:b0:d7a:c4dc:e7b3 with SMTP id
 d134-20020a25688c000000b00d7ac4dce7b3mr15154318ybc.61.1694009136339; Wed, 06
 Sep 2023 07:05:36 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <0ef44108-2a81-89df-c839-0c16d9499c29@huaweicloud.com>
From:   Jason Moss <phate408@gmail.com>
Date:   Wed, 6 Sep 2023 07:05:25 -0700
Message-ID: <CA+w1tCeUZET9KCcBWb89FXNjuvA-M25yCrkF5OqcdZXLQsAhxw@mail.gmail.com>
...
6397                               atomic_read(&conf->reshape_stripes)=3D=
=3D0
...
On Mon, Sep 4, 2023 at 6:08=E2=80=AFPM Yu Kuai <yukuai1@huaweicloud.com> wr=
ote:
>
> Hi,
>
...
> > root       24593  0.0  0.0      0     0 ?        I<   09:22   0:00 [rai=
d5wq]
> > root       24594 96.5  0.0      0     0 ?        R    09:22   2:29 [md0=
_raid6]
> > root       24595  0.3  0.0      0     0 ?        D    09:22   0:00 [md0=
_reshape]
> >
...
> > Thank you
> >
> > On Sun, Sep 3, 2023 at 6:41=E2=80=AFPM Yu Kuai <yukuai1@huaweicloud.com=
> wrote:
> >>
> >> Hi,
> >>
...
> >>> mdadm --grow --raid-devices=3D9 --backup-file=3D/root/grow_md0.bak /d=
ev/md0
> >>>
> >>> The reshape started off fine, the process was underway, and the volum=
e
> >>> was still usable as expected. However, 15-30 minutes into the reshape=
,
> >>> I lost access to the contents of the drive. Checking /proc/mdstat, th=
e
> >>> reshape was stopped at 0.6% with the counter not incrementing at all.
> >>> Any process accessing the array would just hang until killed. I waite=
d
> >>
> >> What kernel version are you using? And it'll be very helpful if you ca=
n
> >> collect the stack of all stuck thread. There is a known deadlock for
> >> raid5 related to reshape, and it's fixed in v6.5:
> >>
> >> https://lore.kernel.org/r/20230512015610.821290-6-yukuai1@huaweicloud.=
com
> >>
> >>> a half hour and there was still no further change to the counter. At
> >>> this point, I restarted the server and found that when it came back u=
p
...
> >>>
> >>> I searched furiously for ideas and tried stopping and reassembling th=
e
...
> >>
> >> https://lore.kernel.org/r/20230512015610.821290-3-yukuai1@huaweicloud.=
com
> >>
> >> Thanks,
> >> Kuai
...
> >>> rebuild onto a new drive once the reshape finishes. However, this mad=
e
...
> >>>
> >>> Down to 0 drives of redundancy (in the reshaped section at least), no=
t
...
> >>> new array in another server and restored from a backup. However, ther=
e
> >>> is still some data not captured by the most recent backup that I woul=
d
...
> >>> smartctl 7.2 2020-12-30 r5155 [x86_64-linux-5.15.0-76-generic] (local=
 build)
...
> >>>      Array State : AA.AAAAA. ('A' =3D=3D active, '.' =3D=3D missing, =
'R' =3D=3D replacing)
> >>>
...
> >>>      Array State : AAAAAAAA. ('A' =3D=3D active, '.' =3D=3D missing, =
'R' =3D=3D replacing)
> >>>
