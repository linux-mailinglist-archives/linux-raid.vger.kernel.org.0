...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3009276AA9E
	for <lists+linux-raid@lfdr.de>; Tue,  1 Aug 2023 10:14:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230421AbjHAIN7 (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Tue, 1 Aug 2023 04:13:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34566 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232156AbjHAINz (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Tue, 1 Aug 2023 04:13:55 -0400
Received: from mailbox.box.xen0n.name (mail.xen0n.name [115.28.160.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 343361FCB;
        Tue,  1 Aug 2023 01:13:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=xen0n.name; s=mail;
        t=1690877622; bh=vKJWjAhuPaVcEm0frFof09dYREIiYcZ0o8/K2aY42uw=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=wG7mGGrYDwzOqGeRJyawuu0WjXb5OlgWTZ8wsQWYIYztPbgjmGXLvrKRDa2WNt3+a
         bgHnm+YJH7c85l0YGeYre3VJNhGbttafd2cKhd6fL/kvhX10lmVkpmLMBHIO3k+8Q6
         8GGBnTZKx2g4qDr7oywzD2sYlfWleRQMFEDdlkS0=
Received: from ld50.lan (unknown [101.88.28.229])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
        (No client certificate requested)
        by mailbox.box.xen0n.name (Postfix) with ESMTPSA id 84CBD6019D;
        Tue,  1 Aug 2023 16:13:42 +0800 (CST)
From:   WANG Xuerui <kernel@xen0n.name>
To:     Song Liu <song@kernel.org>
Cc:     Huacai Chen <chenhuacai@kernel.org>, linux-raid@vger.kernel.org,
        loongarch@lists.linux.dev, linux-kernel@vger.kernel.org,
        WANG Xuerui <git@xen0n.name>
Subject: [PATCH 2/3] raid6: Add LoongArch SIMD syndrome calculation
Date:   Tue,  1 Aug 2023 16:13:34 +0800
Message-Id: <20230801081335.523097-3-kernel@xen0n.name>
...
unrolled 4 times for LSX and 2 times for LASX.
...
> raid6: using algorithm lasx gen() 12726 MB/s
> raid6: .... xor() 11226 MB/s, rmw enabled

(The int64x4 xor() speed is around 2147 MB/s from an earlier boot, for
comparison.)
...
new file mode 100644
index 0000000000000..fe356881caa81
--- /dev/null
