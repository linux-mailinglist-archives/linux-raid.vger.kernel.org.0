Return-Path: <linux-raid+bounces-2443-lists+linux-raid=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-raid@lfdr.de
Delivered-To: lists+linux-raid@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EDB6951D55
	for <lists+linux-raid@lfdr.de>; Wed, 14 Aug 2024 16:38:10 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 09B6A284791
	for <lists+linux-raid@lfdr.de>; Wed, 14 Aug 2024 14:38:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A36A11BBBC0;
	Wed, 14 Aug 2024 14:35:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="jHkNLjh9"
X-Original-To: linux-raid@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2ABAF1BA872
	for <linux-raid@vger.kernel.org>; Wed, 14 Aug 2024 14:34:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723646104; cv=none; b=qYHGxIPr8Hdbf8aZD6GWcMVRxfEBxp8dWul/464uN5As2ZNn397NIhI8XcRUQzAZWV8vw7tG9zo6v/YF0oSt3JXdnFJyOm/aepOBxivHg7MwmZrO2H5GhKP58dYkQuNHj2h7ohAQbHkhgYydpv6Ff4FhexaR0/31G3GCqw3HmkM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723646104; c=relaxed/simple;
	bh=zehiyL84+Yy7mrEewhGl7U+dyidathI9ZYfp5G8ZHJE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=pryHmo3E4VQ+B/SpopTDbH6P2he0e17DdpfDzcDgLA4BC2T9UKrC6+J3UPp7Cd4SY9mZcvbNmH/7h8PSFZRPGEHGaEh4S77HhP82jGeYJ0/aN4+zr+AK1MzXMpampnqrtxsrZmsqU1V6qk02rA7fjIJmEsevS/28srvbgpYnN+Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=jHkNLjh9; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1723646096;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=d/fY3yXccWWtE+/SQnrMD3l5NmhlIdYNoPV261byjGA=;
	b=jHkNLjh9VZ/eDPZL0xNPhMwKz1lhalBmWj1wZT/Vgq/8JxS0fFeeGV7Q5TyeLTSsjepqVw
	xH0c773OXb1YFJ+bQPm7rfHihsxNJvukDDLqLejxz/H2buea/C7Tuuo7ju45UJHombWtPt
	S7/gs3Mp2Zhuqn66bZrsqYQjLCXqxyQ=
Received: from mx-prod-mc-03.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-637-g_HyB81jMCyA91YB832SxA-1; Wed,
 14 Aug 2024 10:34:50 -0400
X-MC-Unique: g_HyB81jMCyA91YB832SxA-1
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 3BCF91944EB6;
	Wed, 14 Aug 2024 14:34:48 +0000 (UTC)
Received: from fs-i40c-03.mgmt.fast.eng.rdu2.dc.redhat.com (fs-i40c-03.mgmt.fast.eng.rdu2.dc.redhat.com [10.6.24.150])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id B80A7300019A;
...
Cc: gfs2@lists.linux.dev,
	...
	aahringo@redhat.com
Subject: [RFC dlm/next 10/12] dlm: separate dlm lockspaces per net-namespace
Date: Wed, 14 Aug 2024 10:34:12 -0400
Message-ID: <20240814143414.1877505-11-aahringo@redhat.com>
...
index 000000000000..239ce69ef0f1
--- /dev/null
+++ b/fs/dlm/config.c
@@ -0,0 +1,699 @@
...
index 9abe71453c5e..ca48c22cbc73 100644
--- a/fs/dlm/config.h
+++ b/fs/dlm/config.h
@@ -1,19 +1,26 @@
 /* SPDX-License-Identifier: GPL-2.0-only */
...
index a98f0e746e9e..a4b449fd3022 100644
--- a/fs/dlm/configfs.c
+++ b/fs/dlm/configfs.c
@@ -1,13 +1,13 @@
 // SPDX-License-Identifier: GPL-2.0-only
...
index 7112958c2e5b..f9e7ca337a62 100644
--- a/fs/dlm/debug_fs.c
+++ b/fs/dlm/debug_fs.c
...
@@ -736,11 +738,15 @@ static const struct file_operations dlm_rawmsg_fops = {
 	.llseek	= no_llseek,
 };
...
@@ -765,6 +775,10 @@ void dlm_create_debug_file(struct dlm_ls *ls)
...
index 865dc70a9dfc..0e8d2b9bf908 100644
--- a/fs/dlm/lock.c
+++ b/fs/dlm/lock.c
