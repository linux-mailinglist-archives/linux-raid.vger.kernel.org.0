Return-Path: <linux-raid+bounces-3143-lists+linux-raid=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-raid@lfdr.de
Delivered-To: lists+linux-raid@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DC539BFFCA
	for <lists+linux-raid@lfdr.de>; Thu,  7 Nov 2024 09:17:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 616881C216DD
	for <lists+linux-raid@lfdr.de>; Thu,  7 Nov 2024 08:17:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 77E991D9592;
	Thu,  7 Nov 2024 08:17:26 +0000 (UTC)
X-Original-To: linux-raid@vger.kernel.org
Received: from dggsgout12.his.huawei.com (dggsgout12.his.huawei.com [45.249.212.56])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 93C3519882F
	for <linux-raid@vger.kernel.org>; Thu,  7 Nov 2024 08:17:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.56
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1730967446; cv=none; b=VR0u28hLF7Ur3HqnKqLd24ueqOpiMco5HPG65c1K1r62tktpCwONW3ELIxK4tFiMEJUtnuvahsZws7VYN5QbTBJgg2tvCKOcl/7XaDx37wH8NBHwQZzywlx5/WK1qBXvVDo8nhqs+I4AaB1Jw6Wp2fZlJLa+nj/7o7cOaS3iFSg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1730967446; c=relaxed/simple;
	bh=HdvpP46Ym81AryvFV57l94m2ngDX+Cws0gSOqQH17PM=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=d1wmu1YxOeBQMkH5h1DvqHU/DdCcjCdfTgKfVlGeN7veHP5VXDyxX5A0DMD3YJ5CTuDaWnXrMl49Tx0gpLu1ugvdfNoxay/traLHpd1l/3h8nyfoat2HJjimk8FROWu81PlxEtCkuIJcc3lhXF34B/JKD7LfzFDJpNtUnU8gSII=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com; spf=pass smtp.mailfrom=huaweicloud.com; arc=none smtp.client-ip=45.249.212.56
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huaweicloud.com
Received: from mail.maildlp.com (unknown [172.19.93.142])
	by dggsgout12.his.huawei.com (SkyGuard) with ESMTP id 4XkZg13WGzz4f3jQv
	for <linux-raid@vger.kernel.org>; Thu,  7 Nov 2024 16:17:01 +0800 (CST)
Received: from mail02.huawei.com (unknown [10.116.40.128])
	by mail.maildlp.com (Postfix) with ESMTP id 7F5471A0359
	for <linux-raid@vger.kernel.org>; Thu,  7 Nov 2024 16:17:19 +0800 (CST)
Received: from huaweicloud.com (unknown [10.175.104.67])
	by APP4 (Coremail) with SMTP id gCh0CgBHI4eMdyxnL91fBA--.3434S7;
...
Subject: [PATCH mdadm/master v2 3/4] mdadm: remove bitmap file support
Date: Thu,  7 Nov 2024 16:13:46 +0800
Message-Id: <20241107081347.1947132-4-yukuai1@huaweicloud.com>
...
X-CM-TRANSID:gCh0CgBHI4eMdyxnL91fBA--.3434S7
X-Coremail-Antispam: 1UD129KBjvAXoWfAF48AF1xJF1fJrW8tw1fWFg_yoW8KryrJo
	WIva45uF4rur10q342yrnxtFZIgw1UKw1SyF1UKr9xua1UX34Y9rWxWw43WasxXr4YgF93
	t3yxXr15Ga18Jry3n29KB7ZKAUJUUUU8529EdanIXcx71UUUUU7v73VFW2AGmfu7bjvjm3
	AaLaJ3UjIYCTnIWjp_UUUYS7kC6x804xWl14x267AKxVW5JVWrJwAFc2x0x2IEx4CE42xK
...
---
 ...
 mdadm.c       | 76 ++++++++++++++++++-----------------------
 mdadm.h       | 18 ++++++----
 9 files changed, 98 insertions(+), 293 deletions(-)
...
index 140a7098..29858483 100644
--- a/Create.c
+++ b/Create.c
...
-	int bitmap_fd;
 	...
 	int container_fd = -1;
 	int need_mdmon = 0;
@@ -536,7 +535,7 @@ int Create(struct supertype *st, struct mddev_ident *ident, int subdevs,
...
index 31786941..fae5b8a7 100644
--- a/Grow.c
+++ b/Grow.c
...
index 8cb4ba66..82a48722 100644
--- a/mdadm.c
+++ b/mdadm.c
@@ -41,18 +41,23 @@
  */
