...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0245B1A5AC
	for <lists+linux-raid@lfdr.de>; Sat, 11 May 2019 02:05:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728094AbfEKAF4 (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Fri, 10 May 2019 20:05:56 -0400
Received: from mx1.redhat.com ([209.132.183.28]:45668 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727921AbfEKAFz (ORCPT <rfc822;linux-raid@vger.kernel.org>);
        Fri, 10 May 2019 20:05:55 -0400
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id 47796308FC4E;
        Sat, 11 May 2019 00:05:55 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
        by smtp.corp.redhat.com (Postfix) with ESMTPS id 3DA315C296;
        Sat, 11 May 2019 00:05:55 +0000 (UTC)
Received: from zmail21.collab.prod.int.phx2.redhat.com (zmail21.collab.prod.int.phx2.redhat.com [10.5.83.24])
        by colo-mx.corp.redhat.com (Postfix) with ESMTP id 29BBB4A460;
        Sat, 11 May 2019 00:05:55 +0000 (UTC)
Date:   Fri, 10 May 2019 20:05:55 -0400 (EDT)
From:   Xiao Ni <xni@redhat.com>
To:     Song Liu <songliubraving@fb.com>
Cc:     linux-raid <linux-raid@vger.kernel.org>, heinzm@redhat.com,
        ncroxon@redhat.com
Message-ID: <1021110953.28040133.1557533155006.JavaMail.zimbra@redhat.com>
In-Reply-To: <FF9BB066-7ED5-4066-B202-D64CFA065ABC@fb.com>
References: <1557474339-18962-1-git-send-email-xni@redhat.com> <FF9BB066-7ED5-4066-B202-D64CFA065ABC@fb.com>
...
Thread-Topic: [PATCH 1/1] raid5-cache: rename r5l_flush_stripe_to_raid to
 r5l_flush_stripe_to_journal
Thread-Index: AQHVBwRjvd/SXYsqzE21nQqCcjj/RqZkjpeABNkMKco=
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.16
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.43]); Sat, 11 May 2019 00:05:55 +0000 (UTC)
