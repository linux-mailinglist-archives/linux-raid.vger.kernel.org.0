...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 486342106FD
	for <lists+linux-raid@lfdr.de>; Wed,  1 Jul 2020 11:01:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729264AbgGAJAY (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Wed, 1 Jul 2020 05:00:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55942 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729245AbgGAJAU (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Wed, 1 Jul 2020 05:00:20 -0400
Received: from casper.infradead.org (casper.infradead.org [IPv6:2001:8b0:10b:1236::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 030F7C03E979;
        Wed,  1 Jul 2020 02:00:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=casper.20170209; h=Content-Transfer-Encoding:MIME-Version:
        References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender:Reply-To:
        Content-Type:Content-ID:Content-Description;
        bh=MJrioLwiDMaTjHlhHFnNGiOK8Kz2X3a88EROOcQ4RTQ=; b=YMd8VgMeJERK/+kU4txHGSvn2a
        ;
Received: from [2001:4bb8:184:76e3:ea38:596b:3e9e:422a] (helo=localhost)
        by casper.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1jqYbH-0008Go-67; Wed, 01 Jul 2020 09:00:15 +0000
...
Message-Id: <20200701085947.3354405-18-hch@lst.de>
...
index cb07a726dd7117..ff9a88d2d244cb 100644
--- a/block/blk-core.c
+++ b/block/blk-core.c
