Return-Path: <linux-raid+bounces-1224-lists+linux-raid=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-raid@lfdr.de
Delivered-To: lists+linux-raid@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id CB0BF88C1F7
	for <lists+linux-raid@lfdr.de>; Tue, 26 Mar 2024 13:22:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7D073301E2A
	for <lists+linux-raid@lfdr.de>; Tue, 26 Mar 2024 12:22:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 46E0874C0B;
	Tue, 26 Mar 2024 12:21:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="MuBvp6sj"
X-Original-To: linux-raid@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2D60C71B42
	for <linux-raid@vger.kernel.org>; Tue, 26 Mar 2024 12:21:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.10
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711455702; cv=none; b=FM7YsBpEwrSQipx89KMMD84SlcHTJlSeL6eXrMnUuN/jouO39M+BF1C9Eem9NVK/9AlUXqhYVidSzLQLFOm7/eo69Od9I4b4ZQCAtrYKoXvnmwiXAi6gJ5uUv0nAG+E1lJhbY6eB/qmhDJvCjBpNQIeBZfYK5UXS/qvyr4g6+yU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711455702; c=relaxed/simple;
	bh=QWteiz489qsqpzWsF5uiAlo9ksS84lfWqFUe2FQqdOg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=bxGv2pazBRUk73arnOEdAPWWn706l9aixwcM48MV3i+gYsTH2TpXKx7E7wH4ABPruN0uba0ZY5vsSrNIQSXtNZewd1EIpmkhKVaGHpX+nPG9CMtyuEHgALKqjEfCBrDeCMZkyDTTrjmuBI4LOV59+Pfk78j9L8K5WizInZh9ZyY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com; spf=none smtp.mailfrom=linux.intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=MuBvp6sj; arc=none smtp.client-ip=192.198.163.10
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1711455698; x=1742991698;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=QWteiz489qsqpzWsF5uiAlo9ksS84lfWqFUe2FQqdOg=;
  b=MuBvp6sjqF6QL0QbBgF6sUKH0vQaMi+8EHu9oS0jxTs7CLpg2C8M83q4
   PvwVdBP27s+rgGuxPFUhvP+swx/l24BuU+jHmitqCrYnF8jmiy8KRIm9z
   qQQxG+PDslJYu8Tp8tepzwKtjtFsbgJMwuv7tt78kB93g83Evagk0Mg7H
   rVZvieMliXdlzKq7sJP4XFvZGfJ1TNU47OOlkVeSzV4ooG1Bv01djyA1h
   HnFD4kmy6Q35KercjmGacExibfo2Uf7LxU8NSbeFYlee0nU646cByDEns
   MUBeuUFrpJ3yZPgYdsLrNUFA5cp9UvzVzVI8IC50RScn/5P6eEL6MLZSO
   g==;
X-CSE-ConnectionGUID: zive0DNCQQOz1L8xcZZhiA==
X-CSE-MsgGUID: JElwjyrbQ/mJAk60gFYByw==
X-IronPort-AV: E=McAfee;i="6600,9927,11024"; a="17891008"
X-IronPort-AV: E=Sophos;i="6.07,156,1708416000"; 
   d="scan'208";a="17891008"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
  by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Mar 2024 05:21:38 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,156,1708416000"; 
   d="scan'208";a="20425513"
Received: from unknown (HELO mtkaczyk-devel.igk.intel.com) ([10.102.108.91])
  by fmviesa005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Mar 2024 05:21:36 -0700
From: Mariusz Tkaczyk <mariusz.tkaczyk@linux.intel.com>
To: linux-raid@vger.kernel.org
Cc: Mariusz Tkaczyk <mariusz.tkaczyk@linux.intel.com>,
	Jes Sorensen <jes@trained-monkey.org>,
	Nix <nix@esperi.org.uk>
Subject: [PATCH 1/3] mdadm: add CHANGELOG.md
Date: Tue, 26 Mar 2024 13:21:10 +0100
Message-Id: <20240326122112.25552-2-mariusz.tkaczyk@linux.intel.com>
...
---
 ...
 CHANGELOG.md   | 368 +++++++++++++++++++++++++++++++++++++++++++++++++
 ChangeLog      | 306 ----------------------------------------
 28 files changed, 368 insertions(+), 1401 deletions(-)
...
index 000000000000..c1997ba759b8
--- /dev/null
+++ b/CHANGELOG.md
@@ -0,0 +1,368 @@
...
deleted file mode 100644
index a3bf7007d839..000000000000
--- a/ChangeLog
+++ /dev/null
@@ -1,306 +0,0 @@
