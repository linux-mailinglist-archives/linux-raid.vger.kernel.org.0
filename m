...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A1908470534
	for <lists+linux-raid@lfdr.de>; Fri, 10 Dec 2021 17:05:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239791AbhLJQJC (ORCPT <rfc822;lists+linux-raid@lfdr.de>);
        Fri, 10 Dec 2021 11:09:02 -0500
Received: from smtp-out2.suse.de ([195.135.220.29]:44644 "EHLO
        smtp-out2.suse.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239799AbhLJQJB (ORCPT
        <rfc822;linux-raid@vger.kernel.org>); Fri, 10 Dec 2021 11:09:01 -0500
Received: from relay2.suse.de (relay2.suse.de [149.44.160.134])
        by smtp-out2.suse.de (Postfix) with ESMTP id 34CCD1F3A1;
        Fri, 10 Dec 2021 16:05:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1639152325; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=0GmlR0M0d/gdlZ5tQG91HrFpNqMx/rZIy1SEeLh5bYU=;
        b=ftRqSj4JjkXii7y19NzSNqxbRiQHvR2oqzPXYDgVLky6WnNWt5qfRCKLSfvpUkjseWp6kO
        9dCzIBVFcLgqopLRoYHlUiRN0kyheKLvKPcqLblDGU+Mf+gEMSoxy5SOaH1T8Kz2FapQtH
        qWp1g3Mxe2TrZJWiX99PrWBU3Fo0KC8=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1639152325;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=0GmlR0M0d/gdlZ5tQG91HrFpNqMx/rZIy1SEeLh5bYU=;
        b=+ONHVZCR7Qcv1EXcZynhVKwKQvhDX2imHrjOpgaI41njOmjQPqh4hwHFCZeGXe96xRplkz
        TYFkTuqaCctoZaDw==
Received: from suse.localdomain (colyli.tcp.ovpn1.nue.suse.de [10.163.16.22])
        by relay2.suse.de (Postfix) with ESMTP id E239FA3B98;
...
Subject: [PATCH v5 3/6] badblocks: improve badblocks_set() for multiple ranges handling
Date:   Sat, 11 Dec 2021 00:04:52 +0800
Message-Id: <20211210160456.56816-4-colyli@suse.de>
